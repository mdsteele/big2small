...
DataX_Forest1_puzz:
    ...
    D_BPTR DataX_Forest1Intro_dlog, 0, 0, 0
    DB W_TST, O_EMP, O_EMP, O_EMP, O_GRS, O_GRS, O_GRS, W_TTP, W_TST, W_TST
    D_BPTR DataX_Forest1Outro_dlog, 0, 0, 0
...
DataX_Forest3_puzz:
    ...
    DB TILESET_PUZZ_FARM, COLORSET_AUTUMN, 0, 0, 0, 0
...
DataX_Bush1_puzz:
    ...
    DB TILESET_PUZZ_FARM, COLORSET_WINTER, 0, 0, 0, 0
...
DataX_Mountain1_puzz:
    ...
    DB TILESET_PUZZ_MOUNTAIN, COLORSET_SUMMER, 0, 0, 0, 0
...
DataX_Seaside1_puzz:
    ...
    DB TILESET_PUZZ_SEASIDE, COLORSET_AUTUMN, 0, 0, 0, 0
...
DataX_Seaside2_puzz:
    ...
    DB TILESET_PUZZ_SEASIDE, COLORSET_WINTER, 0, 0, 0, 0
...
DataX_Sewer1_puzz:
    ...
    DB TILESET_PUZZ_SEWER, COLORSET_SEWER, 0, 0, 0, 0
...
DataX_City1_puzz:
    ...
    DB TILESET_PUZZ_CITY, COLORSET_SUMMER, 0, 0, 0, 0
...
DataX_Space1_puzz:
    ...
    DB TILESET_PUZZ_SPACE, COLORSET_SPACE, 0, 0, 0, $78
...
DataX_Space2_puzz:
    ...
    DB TILESET_PUZZ_SPACE, COLORSET_SPACE, 0, 0, 0, 0
