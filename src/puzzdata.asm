...
DataX_Mountain2_puzz:
    .begin
    DB R_STR, R_SOP, R_STR, R_SOP, R_SOP, R_STR, R_SOP, R_SOP, R_SOP, R_STR
    D_ANIM $70, DIRF_SOUTH
    DB R_SOP, R_STR, R_SS3, R_SS3, R_SS3, R_SS3, R_STR, R_SOP, R_SS3, R_SS3
    D_ANIM $84, DIRF_EAST
    DB R_SS3, R_SSE, O_EMP, O_GRS, O_EMP, S_ARW, R_SSW, R_SSE, O_EMP, O_EMP
...
DataX_MountainBonus_puzz:
    .begin
    DB R_SOP, R_STR, R_SS3, R_SS3, R_SS3, R_SS3, R_SS3, R_SS3, R_STR, R_SOP
    D_ANIM $24, DIRF_SOUTH
    DB R_SOP, R_SOP, O_CW3, G_CHS, O_EMP, W_RCK, O_EMP, O_EMP, R_SW3, R_STR
    D_ANIM $60, DIRF_SOUTH
    DB R_STR, R_SS3, O_CW3, O_EMP, O_EMP, S_BSH, O_EMP, S_ARN, R_SSW, R_SOP
    D_ANIM $31, DIRF_SOUTH
    DB R_SS3, O_CW3, W_CSW, O_RMD, W_CS3, W_CS3, M_RNA, W_CSE, O_CE3, R_SS3
    D_BPTR DataX_ComingRound_song
...
DataX_Lake3_puzz:
    ...
    D_ANIM $59, DIRF_WEST
    DB S_BSH, W_TST, O_EMP, S_ARN, G_PNT, O_EMP, O_EMP, O_EMP, O_EMP, W_TTP
    D_BPTR DataX_TitleMusic_song
    DB O_EMP, W_TTR, S_ARE, O_EMP, O_EMP, O_EMP, O_EMP, O_EMP, G_APL, W_TTR
    D_BPTR DataX_Null_dlog
